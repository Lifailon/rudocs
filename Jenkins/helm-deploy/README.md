...
- Создайте секрет (типа `string`) с произвольным название (например, `k3s-token`) с содержимым токена доступа к кластеру Kubernetes и подключите библиотеку `rudocs-shared-library`:
