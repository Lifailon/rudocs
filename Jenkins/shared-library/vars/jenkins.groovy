...
// Функция для очистки builds до указанного количества
...
// Функция получения списка всех jobs
...
// Функция для обработки вложенности jobs в директориях
...
// Основная функция для экспорта jobs
...
// def jenkinsUrl = "http://192.168.3.105:8010"
// def credentials = "ssh-creds"
