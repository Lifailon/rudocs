...
**ruDocs** (ранее **PS-Commands**) - это большая база заметок по синтаксису [PowerShell](/posh.md), командам [Linux](/linux.md) и инструментам [DevOps](/devops.md) на русском языке, собранная на пути от системного администратора Windows систем до DevOps инженера.
...
Репозиторий содержит набор [PowerShell](/PowerShell) и [Bash](/Bash) скриптов, а также коллекцию стеков [Docker Compose](/Docker-Compose) и манифестов [Kubernetes](/Kubernetes), которые поддерживаются в актуальном состояние и эксплуатируется в домашней лаборатории.